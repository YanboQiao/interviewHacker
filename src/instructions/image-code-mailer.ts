...
2. Generate code in the language corresponding to the problem, and provide a concise and easy-to-understand explanation in Chinese as plain text by default, without creating or modifying files.
